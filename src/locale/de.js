module.exports =  {
  ...
  primaryOptions: [
    ...
    "Informationen über ein Objekt erhalten",
    "Informationen über Eigenschaften erhalten",
    "Änderungensmöglichkeiten einschränken",
    "einen String von einem Objekt erstellen",
